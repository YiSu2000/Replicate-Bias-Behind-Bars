...
```{r piechart, fig.cap = "Distribution of race in 2016", echo = FALSE, message = FALSE, out.width="60%", fig.show="hold", fig.align = 'center'}
...
```{r p1, fig.cap = "Security score distribution among race", echo = FALSE, message = FALSE, out.width="60%", fig.show="hold", fig.align = 'center'}
...
```{r p2, fig.cap = "Reintegration score distribution among race", echo = FALSE, message = FALSE, out.width="60%", fig.show="hold", fig.align = 'center'}
...
```{r roc1, fig.cap = "ROC Male Security Level Model", echo = FALSE, message = FALSE, out.width="70%", fig.align = 'center'}
...
```{r roc2, fig.cap = "ROC Female Security Level Model", echo = FALSE, message = FALSE, out.width="70%", fig.align = 'center'}
...
```{r roc3, fig.cap = "ROC Male Reintegration Model", echo = FALSE, message = FALSE, out.width="70%", fig.align = 'center'}
...
```{r roc4, fig.cap = "ROC Female Reintegration Model", echo = FALSE, message = FALSE, out.width="70%", fig.align = 'center'}
...
```{r trace1, fig.cap = "Trace plots for male security level model", echo = FALSE, message = FALSE, out.width="80%", fig.align = 'center'}
mcmc_plot(model1m, type = "trace")
#no divergence during the chains 
```

```{r trace2, fig.cap = "Trace plots for female security level model", echo = FALSE, message = FALSE, out.width="80%", fig.align = 'center'}

mcmc_plot(model1f, type = "trace")
#no divergence during the chains in all models
```

```{r trace3, fig.cap = "Trace plots for male reintegration potential model", echo = FALSE, message = FALSE, out.width="80%", fig.align = 'center'}
mcmc_plot(model2m, type = "trace")

#no divergence during the chains in all models
```

```{r trace4, fig.cap = "Trace plots for female reintegration potential model", echo = FALSE, message = FALSE, out.width="80%", fig.align = 'center'}
