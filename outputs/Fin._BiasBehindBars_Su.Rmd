...
model1f <- brm(MAXSEC ~ RACE + AGE + static + fiscalyear + sentencetype, 
            data = data1f, 
            family = bernoulli(),
            seed = 6431,
            #seed not perfect in brm, but better than nothing
